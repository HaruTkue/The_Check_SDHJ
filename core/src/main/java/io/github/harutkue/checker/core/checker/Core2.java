...
public class Core2 {
    ...
    public static Map<String, String> SearchAns3(CheckerRecords CheckData) {
        ...
        try (CloseableHttpClient client = HttpClients.createDefault()) {
            ...
            request.setHeader("Host", CheckData.Record().replaceAll("\\.$", ""));
    ...
    public static Map<String, String> SearchN(CheckerRecords CheckData) {
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "curl/8.1.2");
    ...
    // Subdomain検知
    public static Map<String, String> SearchNS(CheckerRecords CheckData) {
        String CheckDomainRecord = CheckData.DomainData().replaceAll("\\.$", "");
        String url = "https://" + CheckDomainRecord;
